...
SparseConvTransposeImpl::SparseConvTransposeImpl(const std::shared_ptr<ngraph::Node> &node) {
    try {
...
SparseConvTransposeImpl::getSupportedConfigurations(std::vector<InferenceEngine::LayerConfig> &conf,
...
InferenceEngine::StatusCode
SparseConvTransposeImpl::execute(std::vector<InferenceEngine::Blob::Ptr> &inputs,
